...
import {MdQuiz, MdOutlineMail} from 'react-icons/md'
          ...
          <MDBRow className="mt-3">
            ...
            <MDBCol md="5" lg="4" xl="4" className="mx-auto mb-md-0 mb-4">
              ...
              <p>
                <MDBIcon className="me-3 d-flex justify-content-center align-items-center" />
                <FaGithubSquare /> &nbsp;
                <Link to="https://github.com/sha-nky" target="_blank">
                  GitHub
                </Link>
              </p>
            </MDBCol>
